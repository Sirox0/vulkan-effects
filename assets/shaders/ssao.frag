...
layout(binding = 0, set = 2) uniform sampler2D gbufferAlbedo;
layout(binding = 1, set = 2) uniform sampler2D gbufferPosition;
layout(binding = 2, set = 2) uniform sampler2D gbufferNormal;
