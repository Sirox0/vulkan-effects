...
void modelViewSceneInit() {
...

    {
        ...
        pipelineInfos[4].renderingInfo.pColorAttachmentFormats = (VkFormat[]){VK_FORMAT_R8G8B8A8_UNORM};
        ...
        pipelineInfos[5].stages[1].pSpecializationInfo = &specializationInfos[2];
